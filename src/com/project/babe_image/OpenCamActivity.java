...
public class OpenCamActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        orientationEventListener = new OrientationEventListener(this) {
			...
			public void onOrientationChanged(int orientation) {
				OpenCamActivity.this.onOrientationChanged(orientation);
			}
        };
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	 ...
	 @Override
	    ...
	    public void clickedSettings(View view) {
			...
			Intent intent = new Intent(this, MyPreferencActivity.class);
...
//			SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
//			String folder_name = sharedPreferences.getString("preference_save_location", "MyIMage");
...
//	    }
		...
		public File getOutputMediaFile(int type){
	    	...
	    	//File mediaStorageDir = getImageFolder();
	    	 File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "baitap/camera");
