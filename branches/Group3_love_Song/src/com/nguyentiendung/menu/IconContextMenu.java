/*
IconContextMenu define a menu with icon and text and some action
 */
package com.nguyentiendung.menu;
...
public class IconContextMenu implements DialogInterface.OnCancelListener, 
	...
	private static final int LIST_PREFERED_HEIGHT = 40;
	 ...
	 * @return
	 */
	public Dialog createMenu(String menuItitle, int xpos, int ypos) { //create menu at x,y, with title menuItitle
	    ...
	    wmlp.x = xpos;   //x position of View
	    wmlp.y = ypos;   //y position of View
    ...
    protected class IconMenuAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
	        	...
	        	temp.setPadding((int)toPixel(res, 12), 0, (int)toPixel(res, 12), 0);
